<?php
namespace Custom\Collection\Block\Widget;

class Categoryproduct extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface
{
    protected $_template = 'widget/customproduct.phtml';
