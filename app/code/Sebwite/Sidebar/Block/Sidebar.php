...
class Sidebar extends Template
{
    ...
    */
    ...
    public function getChildCategoryView($category, $html = '', $level = 1)
    {
        ...
        if ( $category->hasChildren() )
        {
            ...
            if ( count($childCategories) > 0 )
            {
                ...
                $html .= '<ul class="o-list o-list--unstyled child-categories" id="category-'.$category->getId().'">';
                ...
                foreach ( $childCategories as $childCategory )
                {
                    ...
                    if ( $childCategory->hasChildren() )
                    {
                        ...
                        {
                            $html .= '<span class="expanded" id="expand-'.$childCategory->getId().'"><i class="fa fa-minus"></i></span>';
                        }
                        else
                        {
                            $html .= '<span class="expand" id="expand-'.$childCategory->getId().'"><i class="fa fa-plus"></i></span>';
                        }
                    }
    ...
    public function getSubcategories($category)
    {
        ...
        {
        	/*echo "<xmp>";
        	print_r($category->getChildrenCategories());
        	die;*/
        	
        	return (array) $category->getChildrenCategories();
