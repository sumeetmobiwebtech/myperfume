<?php
namespace Ibnab\MegaMenu\Block\Html\Topmega;

/**
 * Interceptor class for @see \Ibnab\MegaMenu\Block\Html\Topmega
 */
class Interceptor extends \Ibnab\MegaMenu\Block\Html\Topmega implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\Data\Tree\NodeFactory $nodeFactory, \Magento\Framework\Data\TreeFactory $treeFactory, \Magento\Catalog\Model\CategoryFactory $categoryFactory, \Magento\Cms\Model\Template\FilterProvider $filterProvider, \Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Cms\Model\BlockFactory $blockFactory, \Magento\Framework\Registry $registry, \Ibnab\MegaMenu\Helper\Data $dataHelper, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $nodeFactory, $treeFactory, $categoryFactory, $filterProvider, $storeManager, $blockFactory, $registry, $dataHelper, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'allowExtension');
        if (!$pluginInfo) {
            return parent::allowExtension();
        } else {
            return $this->___callPlugins('allowExtension', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addIdentity');
        if (!$pluginInfo) {
            return parent::addIdentity($identity);
        } else {
            return $this->___callPlugins('addIdentity', func_get_args(), $pluginInfo);
        }
    }
